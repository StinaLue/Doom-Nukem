...
/*   Updated: 2019/11/14 17:46:21 by phaydont         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	main_loop(t_doom *doom)
{
	...
	*/
	...
	t_vec mid_window_top = {ROT_MAP_WIDTH - 1, 0};
	t_vec mid_window_bottom = {ROT_MAP_WIDTH - 1, ROT_MAP_HEIGHT - 1};
	...
	while (!doom->data.quit)
	{
		...
		draw_line(mid_window_top, mid_window_bottom, doom->sdl.rot_mmap, 0xFFFFFF);
